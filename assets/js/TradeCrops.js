function tradecrops() {
  ...
  if (!crop.localeCompare("Виноград")) {
  ...
  if (!crop.localeCompare("Картопля")) {
  ...
  if (!crop.localeCompare("Кукурудза")) {
  ...
  if (!crop.localeCompare("Помідори")) {
  ...
  if (!crop.localeCompare("Соняшник")) {
  ...
  if (!crop.localeCompare("Цукрова свекла")) {
