          ...
          <ul class="navbar-nav align-items-lg-center ml-auto topnav">
			 ...
			 <li class="nav-item">
              <a href="afarmers.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fas fa-users"></i> Фермери</span
                >
              </a>
            </li>
			...
			<li class="nav-item">
              <a href="acustomers.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fas fa-users"></i> Покупці</span
                >
              </a>
            </li>
			...
			<li class="nav-item">
              <a href="aproducedcrop.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fad fa-store-alt"></i> Запас урожаю</span
                >
              </a>
            </li>
			...
			<li class="nav-item">
              <a href="aviewmsg.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fas fa-address-card"></i> Повідомлення</span
                >
              </a>
            </li>
