...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">Повідомлення</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-info mb-3">
				  ...
				  <span class=" text-primary display-4" > Питання  </span>
		 ...
		 <tr class="text-center">
						...
						<td > <button class="btn btn-sm btn-danger" > <a href="amsgdelete.php?id=<?php echo $res['c_id']; ?>"  class=" nav-link text-white">Видалити</a> </button> </td>
