      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			...
			<a class="dropdown-item" href="../customer/cregister.php">Продавець</a>
		  </div>
		</div>
			</li>
		  ...
		  <a class="nav-link dropdown-toggle text-success " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  ><i class="text-success fas fa-sign-in-alt"></i> Логін</span
                >
		  </a>
		   ...
		   <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			...
			<a class="dropdown-item" href="alogin.php">Адміністратор </a>
		  </div>
		</div>
			</li>
...
<div class="container">
 ...
 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-info badge-pill mb-3">Логін</span>
          </div>
        </div> 
...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-success" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Логін адміністратора</a>
           ...
           <div class="card card-body bg-gradient-success">
                ...
                <form  method="post" action="">     
                    ...
                    <label for="name" class="col-md-3 col-form-label"
                      ><h6 class="text-white font-weight-bold">ID адміністратора</h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
            ...
            <div class="input-group mb-3">
              ...
              <input name="admin_password" type="password"  class="input form-control" id="password" placeholder="Пароль" required="true" aria-label="password" aria-describedby="basic-addon1" />
