...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">Рахунок</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-dark bg-gradient-secondary mb-3">
				  ...
				  <span class=" text-warning display-4" > Рахунок </span>
      ...
      <div class="invoice">
         ...
         <div class="invoice-company text-inverse f-w-600">
            ...
            <a href="javascript:;" onclick="window.print()" class="btn btn-sm btn-white m-b-10 p-l-5"><i class="fa fa-print t-plus-1 fa-fw fa-lg"></i> Друк</a>
			<a  class="btn btn-sm btn-default m-b-10 p-l-5" href="cprofile.php"> <i class="fa fa-rotate-left t-plus-1 fa-fw fa-lg"></i> На головну</a>
            </span>
            Аграрний портал 
         </div>
         <!-- end invoice-company -->
            ...
            <div class="table-responsive">
               <table class="table table-invoice">
                  <thead>
                     <tr>
                        <th>Назва товару</th>
                        <th class="text-center" width="10%">Кількість</th>
                        <th class="text-center" width="10%">Ціна</th>
                  ...
                  <tbody>
                    ...
                    <?php
                        while($rows=pg_fetch_assoc($cartresult))
                        {
                    ?>
            ...
            <div class="invoice-price">
               <div class="invoice-price-left">
                  <div class="invoice-price-row">
                     <p>Виплачувана сума</p>
                  </div>
               </div>
               <div class="invoice-price-right">
                  <small>Всього</small> <span class="f-w-600">₴ &nbsp<?php echo $totalPrice ?></span>
               </div>
            </div>
            <!-- end invoice-price -->
         </div>
...
document.addEventListener("DOMContentLoaded", function() {
  // Ваш код PHP для виконання після повного відображення сторінки
  <?php
    $queryDellAll="DELETE FROM cart ";
    $resultDellAll = pg_query($conn, $queryDellAll);
