		  ...
		  <li class="nav-item">
              <a href="cbuy_crops.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fas fa-shopping-cart"></i> Купити </span
                >
              </a>
            </li>
			...
			<li class="nav-item">
              <a href="cstock_crop.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-white fad fa-store-alt"></i> Запаси врожаю</span
                >
              </a>
            </li>
		   ...
		   <li class="nav-item">
              <a href="clogout.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-danger fas fa-power-off"></i> Вихід </span
                >
              </a>
            </li>
