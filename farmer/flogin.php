      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <a class="nav-link dropdown-toggle text-success " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  ><i class="text-success fas fa-sign-in-alt"></i> Увійти</span
                >
		  </a>
...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Вхід фермера</a>
           ...
           <div class="card card-body bg-gradient-warning">
                 ...
                 <form method="POST" action="">     
                    ...
                    <label for="email" class="col-md-3 col-form-label"
                      ><h6 class="text-white font-weight-bold">Email </h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
                      ...
                      />
				  			  		 ...
				  			  		 <div class="form-group row">
                <label for="pass" class="col-md-3 col-form-label text-white" > Пароль </label>
			   <div class="col-9">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock"></i></span>
              </div>
              <input name="farmer_password" type="password"  class="input form-control" id="password" placeholder="Пароль" required="true" aria-label="password" aria-describedby="basic-addon1" />
