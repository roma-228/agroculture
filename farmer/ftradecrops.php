...
<div class="container ">
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-success display-4" > Оновлення врожаю  </span>					
				  </div>
			...
			<strong class="text-center text-dark ">Поточна середня ринкова ціна на <span id="crop"></span> : <span id="price"></span></strong>
			...
			<strong class="text-center text-dark ">Успішно додано</strong>
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
    ...
    <thead>
					...
					<th><center>Ціна фермера</center></th>
					<th><center>Завантажте деталі урожаю</center></th>
                    ...
                    <tbody>
						...
						<select id="crops" name="crops" class="form-control ">
							<option value="">Оберіть урожай</option>
							...
							<option value="Цукрова свекла">Цукрова свекла</option>
							...
							<option value="Гречка">Гречка</option>
  							<option value="Огірки">Огірки</option>
							<option value="Помідори">Помідори</option>
							<option value="Буряк">Буряк</option>
							<option value="Морква">Морква</option>
						</select>					
						</div>					
						</td>
                        ...
                        <td>
                        <center>
                        <button type="submit" name="Crop_submit" value="Crop_submit" class="btn btn-success">Надіслати</button>
                        </center>
                        </td>
                    </tr>
