    ...
    >
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="flogin.php">Фермер</a>
...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Зареєструвати фермера</a>
...
<form name="insert" action="" method="post">	
    ...
    $("#success").slideUp(500);
			   ...
			   <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Ім'я фермера <strong class="text-default"> *</strong></label>
                <div class="col-md-9">
			  ...
			  <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Номер телефону <strong class="text-default"> *</strong></label>
                <div class="col-md-9">
                  <input class="form-control" type="phone" pattern="^[0-9]{3}[0-9]{3}[0-9]{2}[0-9]{2}$" title="Введіть дійсний 10-значний номер мобільного телефону (наприклад, 066-ххх-хх-хх)"  name="mobile" required="true"  />
                </div>
              </div>
              ...
              <div class="input-group-append">
                <span class="input-group-text" onclick="password_show_hide();">
                  ...
                  <i class="fas fa-eye-slash d-none" id="hide_eye"></i>
			  			  			  ...
			  			  			  <span class="text-white d-block"> Використовуйте щонайменше 8 символів із принаймні 1 цифрою, великою й малою літерою та спеціальним символом.  </span>
			  		 ...
			  		 <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" >Підтвердження паролю <strong class="text-default"> *</strong></label>
			   <div class="col-9">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock"></i></span>
              ...
              <div class="input-group-append">
			   ...
			   <div class="form-group row">
                ...
                <div class="col-md-9">
            <button name="farmerregister" class=" btn-block btn btn-success"><span class="glyphicon glyphicon-edit"></span> Надіслати</button>		
                </div>		
              </div>
            </form>
